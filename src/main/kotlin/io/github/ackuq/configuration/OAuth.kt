        ...
        oauth(OAuthConfiguration.name) {
            ...
            providerLookup = {
                ...
                OAuthServerSettings.OAuth2ServerSettings(
                    ...
                    clientId = environment.config.propertyOrNull("oauth.googleClientId")?.getString() ?: "",
                    clientSecret = environment.config.propertyOrNull("oauth.googleClientSecret")?.getString() ?: "",
